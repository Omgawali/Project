...
void man(char *name)
{
	...
	{
		printf("Descrption : Used to create new regular file\n");
		printf("Usage :create_file permission\n");
	}
	...
	else if(strcmp(name,"write")==0)
	{
		...
		printf("Usage :write File_name After that enter the data we want to write\n");
	}
	else if(strcmp(name,"ls")==0)
	{
		printf("Descrpition :Used to list all information of files\n");
		printf("Usage :ls\n");
	}
	else if(strcmp(name,"stat")==0)
	{
		printf("Desription :Used to display information of files\n");
	...
	{
		printf("Descriptor :Used to open exisisting file\n");
	...
	{
		printf("Descriptor :Used to delete file\n");
...
int fstat_file(int fd)
{
	...
	printf("\n---------Statitcal Information aboout file---------\n");
	printf("File name :%s\n",temp->FileName);
	...
	if(temp->permission==1)
		...
		printf("File permssion :Write only\n");
	else if(temp->permission==1)
		printf("File permssion :Read & Write only\n");
	...
	while(1)
	{
        ...
        else if(count == 3)
        {
             ...
             else if(strcmp(command[0],"read") == 0)
	         {
              ...
              if(ret ==-4) printf("ERROR: It is not regular file\n");
